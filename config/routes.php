<?php
// Simple routes map: page keys to view file paths.
...
$routes = [
    ...
    'event_detail'     => __DIR__ . '/../views/pages/event_detail.php',
    'login'            => __DIR__ . '/../views/pages/login.php',
    'login_attendee'   => __DIR__ . '/../views/pages/login_attendee.php',
    'login_organizer'  => __DIR__ . '/../views/pages/login_organizer.php',
    'login_admin'      => __DIR__ . '/../views/pages/login_admin.php',
